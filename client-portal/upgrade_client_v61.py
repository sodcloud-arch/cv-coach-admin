...
text=text.replace('</head>','<link rel="stylesheet" href="./assets/cv-rank-real-ui-v63.css">\n</head>',1)
text=text.replace('</body>','<script src="./assets/cv-rank-real-ui-v63.js"></script>\n'+V63+'\n</body>',1)

required=[
    MARKER,
    './assets/cv-rank-v61.css',
    './assets/cv-rank-v61.js',
    './assets/cv-rank-real-ui-v63.css',
    './assets/cv-rank-real-ui-v63.js',
    V63
]
