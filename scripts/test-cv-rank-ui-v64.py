...
for token in ['cv-rank-real-ui-v64.css','cv-rank-real-ui-v64.js','cv-rank-real-ui-v64: cache-fresh-transparent-badges']:
...
if STABLE.exists():
    ...
    for token in ['cv-rank-real-ui-v64-css','cv-rank-real-ui-v64-js','cv-rank-real-ui-v64: cache-fresh-transparent-badges','cv64WorkoutRankHud']:
