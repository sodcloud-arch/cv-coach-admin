...
draft_e2e_migration=read('supabase/migrations/202609140335_adaptive_draft_e2e_v84.sql')
...
for marker,label in [
    ...
    ('run_adaptive_programming_e2e_v84','isolated progression E2E RPC'),
    ("errcode='CV084'",'progression E2E rollback sentinel'),
    ('CV_V84_ADAPTIVE_PROGRAMMING_E2E_OK','progression E2E success contract'),
...
for marker,label in [
    ('run_adaptive_draft_e2e_v84','isolated adaptive draft E2E RPC'),
    ("errcode='CV086'",'adaptive draft rollback sentinel'),
    ('CV_V84_ADAPTIVE_DRAFT_E2E_OK','adaptive draft E2E contract'),
    ('prescription_units_preserved','adaptive draft unit assertion'),
    ('active_source_unchanged','active source invariant'),
    ('volume_reduced','deload volume assertion'),
    ('rir_floor_applied','deload RIR assertion'),
]: require(draft_e2e_migration,marker,label)
...
require(edge,'run_adaptive_programming_e2e_v84','service progression E2E RPC')
require(edge,'run_adaptive_draft_e2e_v84','service adaptive draft E2E RPC')
require(edge,'CV_V84_ADAPTIVE_PROGRAMMING_FULL_E2E_OK','edge full success contract')
require(e2e,"contract:'CV_V84_ADAPTIVE_PROGRAMMING_FULL_E2E_OK'",'full E2E assertion')
require(e2e,'suggested_duration_seconds:35','time progression assertion')
require(e2e,'prescription_units_preserved:true','adaptive draft unit assertion')
require(e2e,'active_source_unchanged:true','active source canary assertion')
...
require(deploy,'PUBLIC_ADMIN_V83_OK','preserved V83 public deploy marker')
