-- ARCH-1.0 · F1.M1.S4 access hardening
-- Once canonical assignments are backfilled, professionals only see assigned clients.
-- Org Admin retains tenant-wide visibility; Client retains self visibility.
